    ...
    <div class="container-fluid w-50">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-sm-12 mt-5">
                ...
                <div class="card">
                    <h5 class="card-header">Edit Major</h5>
                    <div class="card-body">
                        <form action="{{ url('/majors/update/'.$major->id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name" class="col-12 control-label">Major Name</label>
                                <div class="col-12">
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $major->name }}">
